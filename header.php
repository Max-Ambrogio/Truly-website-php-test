...
<html>
	...
	<body class="<?php echo $body_class; ?>">
		<header class="header">
			<div class="logo">
				<a href="index.php">
					<img src="./dist/img/Truly_logo_black.svg" alt="Truly logo">
				</a>
			</div>
			<nav class="navigation">
				...
				<ul class="menu">
					...
					<li><a href="about-truly.php">About Truly</a></li>
					<li><a href="#">Find Truly</a></li>
					<li><a href="truly-LA.php">Truly LA</a></li>
